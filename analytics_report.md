# Analysis of 60Percent Dynamics Across Datasets

## 📊 Summary Table

| Dataset | 60Percent | Data Points | Change from Previous |
| ------- | --------- | ----------- | -------------------- |
| 2       | 21.46%    | 2           | -                    |
| 3       | 19.62%    | 2           | -1.84%               |
| 4       | 22.00%    | 3           | +2.38%               |
...
#### 🌱 **Phase 1: Initial Growth (datasets 2-6)**

- Character: Gradual increase with low volatility
- Range: 19.62% → 31.45%
- Average growth per period: +2.96% per dataset

#### 📊 **Phase 2: Active Growth (datasets 6-9)**

- Character: Most stable and steady growth
- Range: 31.45% → 37.84%
- Average growth per period: +2.13% per dataset

#### 🎢 **Phase 3: Volatility (datasets 9-14)**

- Character: High volatility with extreme values
- Includes maximum drop (-4.89%) and maximum growth (+11.27%)
- Achievement of absolute maximum at 45.67%

#### 🎯 **Phase 4: Stabilization (datasets 14-17)**

- Character: Fluctuations around 38-40% level
